...
@interface CSJNativeAdAdapter () <BUNativeAdDelegate>
...
@implementation CSJNativeAdAdapter
...
- (void)nativeAdDidBecomeVisible:(BUNativeAd *)nativeAd {
    MPLogInfo(@"CSJ nativeAdDidBecomeVisible");
...
- (void)nativeAdDidClick:(BUNativeAd *)nativeAd withView:(UIView *_Nullable)view {
    MPLogInfo(@"CSJ media nativeAdDidClick");
